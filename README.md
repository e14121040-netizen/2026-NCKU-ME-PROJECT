...
- **驅動方式**：左右各 1 顆 JGB37-555 DC 12V 66rpm 直流減速馬達，原地旋轉轉向
...
- **供電**：18650 鋰電池 4S ×2 組（上半部 4S 供 RotatingArm / 夾爪；腿部 + FixedStage 4S 供 C3 #1 / C3 #3、腿部馬達、固定端 spin/Gate）+ XL4015 降壓模組 5A ×2（上半部 Servo ×3 / Gate servo 分開）+ LM2596 降壓模組 3A ×2（上半部 C3 #2 / 腿部 + FixedStage C3 #1/#3）
