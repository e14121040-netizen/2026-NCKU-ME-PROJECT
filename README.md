...
- **馬達驅動**：BTS7960 (IBT-2) ×3（#1/#2 步行馬達×2、#3 大圓盤）+ L298N #2（z升降）+ MG996R Servo ×3（r 齒條、θ 旋轉、夾爪開合，由 C3 #3 GPIO PWM 直接驅動）
...
| 陳翊家 | E14102119 | 腿部子控板 ESP32-C3 程式、電源走線管理、腿部機構、電控、L298N 接線、ESP-NOW 通訊 |
