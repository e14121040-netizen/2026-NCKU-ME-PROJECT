...
# =====================================================
# PID 循跡參數
# PID（比例-積分-微分）控制器用於調整機器人沿黑線行駛的轉向
KP = 1.2       # 比例增益：控制當前誤差的響應強度，值越大轉向越快
KI = 0.01      # 積分增益：累積過去誤差，消除靜態誤差，值太大会導致振盪
KD = 0.5       # 微分增益：預測誤差變化趨勢，減少超調，值越大穩定性越好
BASE_SPEED = 100  # 基礎行駛速度 (mm/s)：機器人前進的基本速度
